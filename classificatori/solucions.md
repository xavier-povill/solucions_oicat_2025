...
$$\text{nombre de angles aguts} = 3 \cdot \text{nombre de triangles acutangles} + 2 \cdot \text{nombre de triangles no acutangles} = 3 \cdot \text{nombre de triangles acutangles} + 2 \cdot (\text{nombre de total de triangles} -\text{nombre de triangles acutangles}) = \text{nombre de triangles acutangles} + 2\binom{n}{3}$$
